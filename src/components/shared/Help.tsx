...
import { helpWalk } from '../../utils/helpWalk'
...
function HelpText(props: Readonly<{ html: string }>) {
  const cls = useStyles()
  ...
  useEffect(() => {
    if (ref.current) {
      ...
      helpWalk(ref.current as any, (node) => {
...
export function Help(props: Readonly<Props>) {
